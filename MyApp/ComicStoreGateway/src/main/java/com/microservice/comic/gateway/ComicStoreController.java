...
public class ComicStoreController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/comicsfulldetails/addComic")
	public String addComic(Model model, @ModelAttribute Comics c, BindingResult bindingResult) {
...
*/	
	...
	private String defaultFallbackSend(Model model, Comics c, BindingResult bindingResult) {
		System.out.println("In fallback post");
		return "index";
	}
